...
(function ($) {
  ...
  Beats.Controller('Beats.Modal.Dialog', {
    ...
    init: function (el, opts) {
      ...
      self.element.html(self.options.view, self.options.tplV, Beats.view({}), function () {
        self.element.addClass('modal hide fade')
        self.element.attr({
          id: self.options.id,
          tabindex: '-1',
          role: 'dialog',
        ...
        self.element.on({
          'show': _.proxy(self, 'show'),
          'shown': _.proxy(self, 'shown'),
          'hide': _.proxy(self, 'hide'),
          'hidden': function (evt) {
